        ...
        <div className="make-point-div">
            <div style={visability} className="addnote-div">
                <div className="title-and-cross">
                    ...
                    <button onClick={() => { setnotes([[0, 0]]); setvisability({ "display": "none" }); }} className="close">&times;</button>
                </div>
            ...
            <Modal show={show} onHide={() => { handleClose() }} centered>
                <div className="modal-set-locations">
                    ...
                    <Modal.Body>Here you can create your own dot with some extra notes on this map. Just click or tap anywhere and in appeared window type your unique note!</Modal.Body>
                    <Modal.Footer>
